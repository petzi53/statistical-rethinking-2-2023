...
::: my-solution
::: my-solution-header
####### Example 2E1: Which of the expressions below correspond to the statement: *the probability of rain on Monday*? {#chap-02-e1}
:::
...
::: my-solution
::: my-solution-header
####### Example 2E2: Which of the following statements corresponds to the expression: $Pr(Monday|rain)$?
:::
...
::: my-solution
::: my-solution-header
####### Example 2E3: Which of the expressions below correspond to the statement: *the probability that it is Monday, given that it is raining*? {#chap-02-e3}
:::
...
::: my-solution
::: my-solution-header
####### Example 2E4: Does probability exist?
:::
...
::: my-solution
::: my-solution-header
####### Example 2M1: Globe tossing model -- Compute and plot the grid approximate posterior distribution for each of the following sets of observations.
:::
...
::: my-solution
::: my-solution-header
####### Example 2M2: Now assume a prior for $p$ that is equal to zero when $p < 0.5$ and is a positive constant when $p ≥ 0.5$. 
:::
...
::: my-solution
::: my-solution-header
####### Example 2M3: Suppose there are two globes, one for Earth and one for Mars.
:::
...
::: my-solution
::: my-solution-header
####### Example 2M4: Suppose you have a deck with only three cards {#example-2m4}
:::
...
::: my-solution
::: my-solution-header
####### Example example-number and title
:::
