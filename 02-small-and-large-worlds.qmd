...
@cnj-fig-bayesian-updating we will learn how to write R code to
reproduce the book's figure as @fig-bayesian-update. To inspect the
different steps of the updating process is essential to understand
Bayesian statistics!
:::
:::
...
## I STOPPED HERE!! SECOND PASS (2023-10-28) {.unnumbered}
