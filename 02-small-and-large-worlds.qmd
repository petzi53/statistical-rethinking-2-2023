...
1.  Creates a tibble from all combinations of inputs. @sec-annotation-1-expand-grid.
...
4.  Restore the original ungrouped data structure. @sec-annotation-4-ungroup.
...
The result is already shown under @sec-annotation-2-group_by in the result of the code listing @tbl-bayesian-model-learning-anno2-1.
...
`base::dbinom()`, to calculate two alternative events and will be
explained later in more detail. REFERENCE??
