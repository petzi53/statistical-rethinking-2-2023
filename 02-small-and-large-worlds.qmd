...
```{r}
#| label: code-2-1
#| attr-source: '#lst-code-2-1 lst-cap="Compute Plausibilities in R"'
...
@lst-fig-bayesian-update we will learn how to write R code to reproduce
...
#| attr-source: '#lst-globe-tossing-data lst-cap="Save globe tossing data int to tibble"'
...
#| attr-source: '#lst-bayesian-updating-start lst-cap="Bayesian updating preparation"'
...
#| attr-source: '#lst-fig-bayesian-update lst-cap="Bayesian updating: How a model learns"'
...
#| attr-source: '#lst-bayesian-update-1 lst-cap="Create a tibble from all input combinations"'
...
#| attr-source: '#lst-bayesian-update-2 lst-cap="Bayesian Updating: Lagged with groupping"'
...
#| attr-source: '#lst-bayesian-update-2a lst-cap="Bayesian Updating: Lagged without groupping"'
...
#| attr-source: '#lst-bayesian-update-5 lst-cap="Bayesian Updating: Calculating prior and likelihood"'
...
#| attr-source: '#lst-bayesian-update-6 lst-cap="Bayesian Updating: Normalizing prior and likelihood"'
...
#| attr-source: '#lst-fig-bayesian-update-7 lst-cap="Demonstrating Bayesian Updating"'
...
## I STOPPED HERE!! SECOND PASS (2023-10-25) {.unnumbered}
