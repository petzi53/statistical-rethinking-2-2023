...
with the amount of data, is very common. It\'s one of the reasons that
so many classical statistical procedures are nervous about small
samples.
...
It\'s weird. But it works. The **METROPOLIS ALGORITHM** is explained in
[Chapter 9](javascript:void(0)).
