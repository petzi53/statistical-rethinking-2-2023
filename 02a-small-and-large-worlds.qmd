...
## 2.1a Bayesian Probability of the Water Proportion
...
## 2.2a Test Before You Est(imate)
...
### 2.2.1a Simulating the Globe Tossing
...
### 2.2.2a Test the simulation at extreme values
...
### 2.2.3a Code an estimator and test it with the simulation
