...
I am working on a second draft where I will shorten my notes but include the exercises under the practice section. I will also reformat the text by including different special callout boxes linked by numbered and named references. This second draft is currently working on the exercises of the second chapter, e.g. it has finished e.g., $\approx 8\%$ of the book content.
